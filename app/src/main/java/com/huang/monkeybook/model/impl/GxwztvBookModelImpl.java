...
import com.huang.monkeybook.common.api.IGxwztvApi;
import com.huang.monkeybook.ErrorAnalyContentManager;
import com.huang.monkeybook.base.MBaseModelImpl;
...
public class GxwztvBookModelImpl extends MBaseModelImpl implements IGxwztvBookModel {
    ...
    public Observable<List<SearchBookBean>> getKindBook(String url, int page) {
        url = url + page + ".htm";
        return getRetrofitObject(GxwztvBookModelImpl.TAG).create(IGxwztvApi.class)
                .getKindBooks(url.replace(GxwztvBookModelImpl.TAG, ""))
                .flatMap((Function<String, ObservableSource<List<SearchBookBean>>>) this::analySearchBook);
    }
}
