...
import com.huang.monkeybook.presenter.IBookDetailPresenter;
import com.hwangjr.rxbus.RxBus;
import com.hwangjr.rxbus.annotation.Subscribe;
import com.hwangjr.rxbus.annotation.Tag;
import com.hwangjr.rxbus.thread.EventThread;
import com.huang.monkeybook.listener.OnGetChapterListListener;
import com.huang.monkeybook.view.IBookDetailView;
                    ...
                    .subscribe(new SimpleObserver<Boolean>() {
                        ...
                        public void onNext(Boolean value) {
                            if (value) {
                                ...
                                Toast.makeText(App.getInstance(), "放入书架失败!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    ...
                    .subscribe(new SimpleObserver<Boolean>() {
                        ...
                        public void onNext(Boolean value) {
                            if (value) {
                                ...
                                Toast.makeText(App.getInstance(), "移出书架失败!", Toast.LENGTH_SHORT).show();
                            }
                        }
