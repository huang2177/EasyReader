...
import com.huang.monkeybook.view.adapter.BookShelfAdapter;
import com.huang.monkeybook.view.popupwindow.DownloadListPop;
import com.huang.monkeybook.view.popupwindow.ProxyPop;
import com.huang.monkeybook.BitIntentDataManager;
import com.huang.monkeybook.base.MBaseActivity;
import com.huang.monkeybook.bean.BookShelfBean;
import com.huang.monkeybook.presenter.IMainPresenter;
import com.huang.monkeybook.presenter.impl.BookDetailPresenterImpl;
import com.huang.monkeybook.presenter.impl.ReadBookPresenterImpl;
import com.huang.monkeybook.presenter.impl.MainPresenterImpl;
import com.huang.monkeybook.view.IMainView;
import com.huang.monkeybook.widget.refreshview.OnRefreshWithProgressListener;
import com.huang.monkeybook.widget.refreshview.RefreshRecyclerView;
...
public class MainActivity extends MBaseActivity<IMainPresenter> implements IMainView {
    ...
    protected void bindEvent() {
        bindRvShelfEvent();
        ibSettings.setOnClickListener(v -> proxyPop.showAsDropDown(ibSettings));
        ibDownload.setOnClickListener(v -> downloadListPop.showAsDropDown(ibDownload));
        ibMoney.setOnClickListener(v -> {
            //点击打赏
        });
        ibLibrary.setOnClickListener(v -> startActivityByAnim(new Intent(MainActivity.this, LibraryActivity.class), 0, 0));
