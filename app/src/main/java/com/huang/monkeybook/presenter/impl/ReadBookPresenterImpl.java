...
package com.huang.monkeybook.presenter.impl;
...
import com.huang.basemvplib.impl.BasePresenterImpl;
import com.huang.monkeybook.App;
import com.huang.monkeybook.BitIntentDataManager;
import com.huang.monkeybook.base.observer.SimpleObserver;
...
import com.huang.monkeybook.bean.ReadBookContentBean;
...
import com.huang.monkeybook.dao.DbHelper;
import com.huang.monkeybook.model.impl.ImportBookModelImpl;
import com.huang.monkeybook.model.impl.WebBookModelImpl;
                        ...
                        ImportBookModelImpl.getInstance().importBook(new File(value))
                                ...
                                .subscribe(new SimpleObserver<LocBookShelfBean>() {
                                    ...
                                    public void onError(Throwable e) {
                                        ...
                                        Toast.makeText(App.getInstance(), "文本打开失败！", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
